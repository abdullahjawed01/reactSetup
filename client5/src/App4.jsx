...
function App() {
  return (
    ...
    <div className="bg-liner-to-br from-blue-50 to-indigo-100 min-h-screen p-4 flex justify-center">
    ...
    <div className="bg-linear-to-r from-blue-600 to-indigo-600 text-white p-8">
      <div className="flex flex-col md:flex-row items-center gap-6">
        ...
        <div className="text-center md:text-left">
          <h1 className="text-3xl font-bold tracking-wide">Mohammed Afnaan</h1>
